...
Downsamples dominant classes and oversamples rare classes.
...
from train_common import (
    ...
    chronological_split, stratify_classes, STATIC_XGB_PARAMS, STATIC_LGBM_PARAMS,
)
